### i3 in order to start cetrain application in floating mode

~/.config/i3/config
```
# Windows I would like to float
for_window [class="Slack"] floating enable
for_window [class="zoom"] floating enable
```

In order to find desired window class follwing script might be used:
```bash
#!/bin/sh
